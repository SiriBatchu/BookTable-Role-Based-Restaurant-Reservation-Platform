                ...
                <CardContent>
                  <div className="space-y-3">
                    <div className="flex items-center">
                      ...
                      <div>
                        <p className="font-medium text-white">Reservation Time</p>
                        <p className="text-sm text-white">{formatDateTime(booking.slot_datetime)}</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center">
                      ...
                      <div>
                        <p className="font-medium text-white">Booking Made On</p>
                        <p className="text-sm text-white">{formatDateTime(booking.booking_datetime)}</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center">
                      ...
                      <div>
                        <p className="font-medium text-white">Party Size</p>
                        <p className="text-sm text-white">{booking.number_of_people} {booking.number_of_people === 1 ? 'person' : 'people'}</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-white">{booking.booking_id}</p>
                      </div>
                    </div>
                  </div>
                </CardContent>
